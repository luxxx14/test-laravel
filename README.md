...
5. Приложение будет запущено и доступно на порте 8080.
6. При отправке запросов на api необходимо в заголовке X-API-KEY передать api ключ (который прописан в файле .env)
